...
CREATE TABLE NongSan (
    ...
    DuongDanAnh VARCHAR(255), -- Cột cho đường dẫn ảnh
...
('KH01', 'Nguyen Van A', '123 Duong A, Quan 1', '0901234567'),
('KH02', 'Tran Thi B', '456 Duong B, Quan 2', '0902345678'),
('KH03', 'Le Van C', '789 Duong C, Quan 3', '0903456789'),
('KH04', 'Pham Thi D', '101 Duong D, Quan 4', '0904567890'),
('KH05', 'Hoang Van E', '202 Duong E, Quan 5', '0905678901'),
('KH06', 'Nguyen Thi F', '303 Duong F, Quan 6', '0906789012'),
('KH07', 'Tran Van G', '404 Duong G, Quan 7', '0907890123'),
('KH08', 'Le Thi H', '505 Duong H, Quan 8', '0908901234'),
('KH09', 'Pham Van I', '606 Duong I, Quan 9', '0909012345'),
('KH10', 'Hoang Thi J', '707 Duong J, Quan 10', '0900123456');

CREATE TABLE KieuTaiKhoan (
    MaKieuTaiKhoan VARCHAR(10) PRIMARY KEY,
    TenKieuTaiKhoan VARCHAR(50)
);

INSERT INTO KieuTaiKhoan (MaKieuTaiKhoan, TenKieuTaiKhoan) VALUES
('KT01', 'Admin'),
('KT02', 'Khach Hang');
...
CREATE TABLE TaiKhoan (
    ...
    MaKieuTaiKhoan VARCHAR(10),
    TenTaiKhoan VARCHAR(50),
    MatKhau VARCHAR(50),
    NgayTao DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (MaKhachHang) REFERENCES KhachHang(MaKhachHang),
    FOREIGN KEY (MaKieuTaiKhoan) REFERENCES KieuTaiKhoan(MaKieuTaiKhoan)
);


INSERT INTO TaiKhoan (MaTaiKhoan, MaKhachHang, MaKieuTaiKhoan, TenTaiKhoan, MatKhau) VALUES
('TK01', 'KH01', 'KT02', 'nguyenvana', 'password1'),
('TK02', 'KH02', 'KT02', 'tranthib', 'password2'),
('TK03', 'KH03', 'KT02', 'levanc', 'password3'),
('TK04', 'KH04', 'KT02', 'phamthid', 'password4'),
('TK05', 'KH05', 'KT02', 'hoangvane', 'password5'),
('TK06', 'KH06', 'KT02', 'nguyenthi', 'password6'),
('TK07', 'KH07', 'KT02', 'tranvan', 'password7'),
('TK08', 'KH08', 'KT02', 'lethi', 'password8'),
('TK09', 'KH09', 'KT02', 'phamvan', 'password9'),
('TK10', 'KH10', 'KT02', 'hoangthi', 'password10'),
('TK_ADMIN', NULL, 'KT01', 'admin', '1');
